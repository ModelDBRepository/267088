"""
This script computes the threshold at points along the Reference Curve in Fig 6B.
...
DeltaVrs_values = [-2.0, -1.75, -1.5, -1.25, -1.0, -0.75, -0.5, -0.25, 0.0, 0.25, 0.5, 0.75, 1.0, 1.25, 1.5, 1.75, 2.0] #mV
...
class StartUp():
    ...
    def __init__(self, gamma=None, deviation=None, CrossOverPosition=None, fraction=None, vRS0=None, vRS03 = None):
        ...
        self.vThreshold = -63.0 #-63.0 #-60.0
        ...
        self.amplitude = 5.0
        self.maximumAmplitude=11.0
        self.backProp_criterion = self.min_vpeak_apicalSDtips #self.max_vpeak_apicalSDtips #self.min_vpeak_apicalSDtips #self.get_mainApicalMiddle_vpeak #self.get_mainApicaltip_vpeak #self.mean_vpeak_SDtips
        print('**************************************')
        print('**************************************')
        print('**************************************')
        ...
        self.df_filename = self.backProp_criterion.__name__+'__pandas_data'+'_Lais='+str(self.ais.L)+'_'+self.date_str+self.time_str+'.csv'
    ...
    def sweeper(self, gamma_vals=None, deviation_vals=None, CrossOverPosition_vals=None, vRS03_vals=None):
        ...
        thresHolding_function = self.backProp_thresh  #self.forwardProp_thresh
...
if __name__=='__main__':
    ...
    NaV12_rightshift = 13.0 #mV
    vRS03_array = list(np.array(DeltaVrs_values) + NaV12_rightshift)
    cell.sweeper(gamma_vals=[20.0], deviation_vals=[1.0], CrossOverPosition_vals=[0.5], vRS03_vals=vRS03_array)
    # cell.sweeper(gamma_vals=[20.0], deviation_vals=[1.0], CrossOverPosition_vals=[0.5], vRS03_vals=[11.0, 11.25, 11.5, 11.75, 12.0, 12.25, 12.5, 12.75, 13.0, 13.25, 13.5, 13.75, 14.0, 14.25, 14.5, 14.75, 15.0])
